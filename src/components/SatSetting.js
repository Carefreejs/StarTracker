    ...
    render() {
        return (
            <Form
                ...
                onFinish={this.showSatellite} // 事件处理函数 点击button后发生的函数
            >

                <Form.Item
                    label="Longitude(degrees)"
                    name="longitude" // 作为key传入showSatellite 
                    rules={[
                        {
                            required: true,
                    ...
                    initialValue = {70}
                >
                    <InputNumber min={-180} max={180} //经纬度最小值，最大值的限制设置
                                 style={{width: "100%"}}
                                 placeholder="Please input Longitude" // 没有填写信息后的message
                    />
                </Form.Item>
